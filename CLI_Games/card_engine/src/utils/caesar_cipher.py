...
Most Of The Code Is Cloned From The Algorithms Github Repo, But With
The brute_force_dict_search() Function Added
...
"""
Most Of The Code Is Self-Explanatory, But If You Need More Info,
Please Read The Docstrings.
Most Of The Code Is Cloned From The Encrypt Function, But With A Negative Key To Decrypt
"""


def encrypt(input_string: str, key: int, alphabet: str | None = None) -> str:  # noqa: D417
    """Encrypt.
    ...
    *   https://en.m.wikipedia.org/wiki/Caesar_cipher
    ...
    alpha = alphabet or (ascii_uppercase + digits)
    ...
    while True:
        ...
        match choice:
            ...
            case "3":
                ...
                while True:
                    targetstr = input(
                        "Enter Target Strings To Search For Seperated By Commas If, or Enter If None:  ").strip() or "none"  # noqa: E501
